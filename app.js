...
var incompleteTaskHolder = document.querySelectorAll(".tasklist__incomplete")[0]; //list of incomplete tasks
var completedTasksHolder = document.querySelectorAll(".tasklist__completed")[0]; //completed tasks
...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("task__editmode");
  ...
  listItem.classList.toggle("task__editmode");
};
